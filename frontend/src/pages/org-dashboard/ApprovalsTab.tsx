...
const ApprovalsTab = () => {
    ...
    const gradientSecondary = 'bg-gradient-to-r from-[#1b253f] via-[#2d3a8c] via-[#4b3bb0] to-[#6b2cc1]';
    const gradientText = 'bg-gradient-to-r from-[#1b253f] via-[#2d3a8c] via-[#4b3bb0] to-[#6b2cc1] bg-clip-text text-transparent';
    const gradientBorder = 'bg-gradient-to-r from-[#1b253f] via-[#2d3a8c] via-[#4b3bb0] to-[#6b2cc1]';
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
                        ...
                        >
                            ...
                            >
                                <Button 
                                    variant="outline" 
                                    className="gap-2 text-sm sm:text-base relative overflow-hidden group hover:border-[#2d3a8c] hover:text-[#2d3a8c] transition-colors"
                                    onClick={refreshAllData}
                                    disabled={refreshing}
                                >
                                    <motion.div
                            ...
                            {[
                                ...
                                >
                                    <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-800/50 hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                                        <CardContent className="p-4 sm:p-6 relative">
                                            <motion.div 
                                                className={`absolute inset-0 ${gradientPrimary} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
                                            />
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-xs sm:text-sm font-medium text-muted-foreground">{stat.label}</p>
                                                ...
                                                <motion.div 
                                                    whileHover={{ rotate: 12, scale: 1.1 }}
                                                    className={`h-10 w-10 sm:h-12 sm:w-12 ${gradientPrimary} rounded-xl flex items-center justify-center shadow-lg`}
                                                >
                                    ...
                                    >
                                        <CardTitle className="text-2xl flex items-center gap-2">
                                            <motion.div
                                                ...
                                                className="inline-block"
                                            >
                                                <Clock className="w-6 h-6 text-[#2d3a8c]" />
                                            </motion.div>
                                            Pending Approval Requests
                                        </CardTitle>
                                        <CardDescription>Review and approve courses submitted by department admins or other staff members.</CardDescription>
                                                    ...
                                                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                                        <div className="flex-1 space-y-1">
                                                            <div className="flex items-center gap-2">
                                                                <motion.h3 
                                                                    whileHover={{ x: 5 }}
                                                                    className="font-bold text-xl text-foreground group-hover:text-[#2d3a8c] transition-colors capitalize"
                                                                >
                                                                    {course.title || course.mainTopic}
                                                                </motion.h3>
                                                            ...
                                                            <div className="flex flex-wrap gap-4 mt-3 text-xs font-semibold text-muted-foreground items-center">
                                                                <div className="flex items-center gap-1.5 bg-muted/50 px-2 py-1 rounded-md">
                                                                    <BookOpen className="w-3.5 h-3.5 text-[#2d3a8c]" />
                                                                    <span>{course.topics?.length || 0} Lessons</span>
                                                                </div>
                                                                <div className="flex items-center gap-1.5 bg-muted/50 px-2 py-1 rounded-md">
                                                                    <FileQuestion className="w-3.5 h-3.5 text-[#4b3bb0]" />
                                                                    <span>{course.quizzes?.length || 0} Quizzes</span>
                                                                </div>
                                                                <div className="flex items-center gap-1.5 bg-muted/50 px-2 py-1 rounded-md">
                                                                    <Calendar className="w-3.5 h-3.5 text-[#6b2cc1]" />
                                                                    <span>Submitted: {new Date(course.updatedAt || course.date).toLocaleDateString(undefined, { day: 'numeric', month: 'short', year: 'numeric' })}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="flex flex-wrap gap-2 w-full md:w-auto shrink-0">
                                                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                                                <Button 
                                                                    variant="outline" 
                                                                    size="sm" 
                                                                    className="flex-1 md:flex-none h-10 px-4 rounded-xl border-[#2d3a8c] hover:bg-[#2d3a8c] hover:text-white transition-colors"
                                                                    onClick={() => setPreviewCourse({ ...course })}
                                                                >
                                                                    <Eye className="w-4 h-4 mr-2" /> Preview
                                                                </Button>
                                                            ...
                                                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                                                <Button 
                                                                    className={`flex-1 md:flex-none h-10 px-4 rounded-xl ${gradientPrimary} text-white shadow-lg hover:opacity-90`}
                                                                    size="sm"
                                                                    onClick={() => handleReviewOrgCourse(course._id, 'approved', 'Course approved for students.')}
                                                                >
                                                                    <Check className="w-4 h-4 mr-2" /> Approve
                                                            ...
                                                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                                                <Button 
                                                                    variant="ghost" 
                                                                    size="sm"
                                                                    className="flex-1 md:flex-none h-10 px-4 rounded-xl text-red-600 hover:bg-red-50 hover:text-red-700"
                                                                    onClick={async () => {
                                                                        const result = await Swal.fire({
                                                                            title: 'Reject this course?',
                                                                            input: 'textarea',
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                            <div className="relative flex-1">
                                                ...
                                                <input
                                                    ...
                                                    value={searchQuery}
                                                    onChange={(e) => setSearchQuery(e.target.value)}
                                                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-[#2d3a8c] transition-all duration-300"
                                                />
                                            </div>
                                            <select
                                                value={selectedDepartment}
                                                onChange={(e) => setSelectedDepartment(e.target.value)}
                                                className="px-3 py-2 rounded-lg border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-[#2d3a8c] transition-all duration-300"
                                            >
                                                <option value="all">All Departments</option>
                                                {departmentsList.map((dept) => (
                                                    <option key={dept._id} value={dept._id}>{dept.name}</option>
                                                            ...
                                                            >
                                                                ...
                                                                <div className="p-4 sm:p-6 relative">
                                                                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                                                                        <div className="flex items-center gap-3 sm:gap-4">
                                                                            <motion.div whileHover={{ rotate: 360 }} transition={{ duration: 0.5 }}>
                                                                                <Avatar className="h-12 w-12 sm:h-14 sm:w-14 ring-2 ring-[#2d3a8c]/20 dark:ring-[#2d3a8c]/30">
                                                                    ...
                                                                    <div className="space-y-3 mb-4">
                                                                        <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                                                                            <div className="flex items-center gap-2">
                                                                                <TrendingUp className="h-4 w-4 text-[#2d3a8c]" />
                                                                                <span className="text-xs sm:text-sm font-medium">Requested Limit</span>
                                                                            </div>
                                                                            <motion.span 
                                                                                initial={{ scale: 0 }}
                                                                                animate={{ scale: 1 }}
                                                                                transition={{ type: "spring", stiffness: 200, delay: idx * 0.1 }}
                                                                                className="text-base sm:text-lg font-bold text-[#2d3a8c]"
                                                                            >
                                                                                {request.requestedCourseLimit} courses
                                                                            </motion.span>
                                                                        </div>
                                                                            ...
                                                                            <div className="flex flex-row sm:flex-row lg:flex-col gap-2 lg:min-w-[180px]">
                                                                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                                                                    <Button 
                                                                                        variant="outline" 
                                                                                        size="sm" 
                                                                                        className="gap-2 text-sm w-full hover:border-[#2d3a8c] hover:text-[#2d3a8c] transition-colors"
                                                                                        onClick={() => setPreviewCourse({ ...course })}
                                                                                    >
                                                                                        <EyeIcon className="w-4 h-4" />
                                                                                        Preview
                        ...
                        {previewCourse && (
                            ...
                            >
                                ...
                                >
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                    {previewCourse.topics.map((topic, idx) => (
                                                        <motion.div 
                                                            ...
                                                            className="flex items-center gap-2 p-2 bg-slate-50 dark:bg-slate-800 rounded-lg"
                                                        >
                                                            <div className="w-1.5 h-1.5 bg-[#2d3a8c] rounded-full"></div>
                                                            <span className="text-xs sm:text-sm">{topic}</span>
                                                        </motion.div>
                                                    ))}
                                                </div>
                                    ...
                                    >
                                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                            <Button variant="outline" onClick={() => setPreviewCourse(null)} className="text-sm hover:border-[#2d3a8c] hover:text-[#2d3a8c]">
                                                Close
                                            </Button>
                                        </motion.div>
                                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
