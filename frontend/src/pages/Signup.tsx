...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-full overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(30,138,138,0.08),transparent_25%),linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--background))_100%)]">
      ...
      {/* Responsive Grid Layout - No scroll on form card */}
      <div className="flex min-h-screen flex-col lg:grid lg:min-h-dvh lg:grid-cols-[0.95fr_1.05fr] lg:overflow-hidden">
        {/* ===================== LEFT SIDE - FULL CONTENT (Hidden on Mobile) ===================== */}
        <section className="relative hidden overflow-y-auto bg-slate-950 text-white lg:flex lg:items-center lg:justify-center lg:px-6 xl:px-12">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-xl space-y-6 px-4 sm:px-6 md:space-y-8 py-8"
          >
        ...
        {/* ===================== RIGHT SIDE - FORM (No scroll, fits perfectly) ===================== */}
        <section className="flex items-center justify-center min-h-screen lg:min-h-dvh p-4 sm:p-6 md:p-8 overflow-hidden">
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
            // className="w-full max-w-md mx-auto"
             className="w-full mx-auto max-w-md lg:max-w-[38rem]"
          >
            <Card className="border-slate-200/80 bg-white/90 shadow-lg backdrop-blur sm:shadow-xl overflow-hidden">
              <CardContent className="p-4 sm:p-5 md:p-6 lg:p-7 space-y-4 sm:space-y-5 max-h-[calc(100vh-2rem)] overflow-y-auto">
                <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  ...
                  {/* Row 2: Phone Number (full width or can be adjusted) */}
...
/>
                  ...
                  <div className="flex justify-left py-1 sm:py-2">
                    <div className="flex justify-left overflow-x-auto">
                ...
                <div className="w-full mt-2 sm:mt-3 flex justify-center">
                  <GoogleLogin
                    theme="outline"
