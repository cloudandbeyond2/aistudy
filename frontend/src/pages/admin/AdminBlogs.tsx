    ...
    <>
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button asChild>
            <Link to="/admin/create-blog">Create New Blog</Link>
          </Button>
        </div>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {/* EDIT BUTTON */}
                          <DropdownMenuItem
                            onClick={() => navigate(`/admin/create-blog/${blog._id}`)}
                          >
                          ...
                          {!blog.popular ? (
                            <DropdownMenuItem
                              onClick={() => updateBlog(blog._id, 'popular', 'true')}
                            >
                              <StarIcon className="mr-2 h-4 w-4" />
                              Make Popular
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                              onClick={() => updateBlog(blog._id, 'popular', 'false')}
                            >
                              <StarOffIcon className="mr-2 h-4 w-4" />
                              Remove Popular
                            </DropdownMenuItem>
                          ...
                          {!blog.featured ? (
                            <DropdownMenuItem
                              onClick={() => updateBlog(blog._id, 'featured', 'true')}
                            >
                              <TrendingUpIcon className="mr-2 h-4 w-4" />
                              Make Featured
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                              onClick={() => updateBlog(blog._id, 'featured', 'false')}
                            >
                              <TrendingDownIcon className="mr-2 h-4 w-4" />
                              Remove Featured
                            </DropdownMenuItem>
