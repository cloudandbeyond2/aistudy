...
// // Update the LoadingPopup component to handle 10 modules better
// const LoadingPopup = ({ isOpen, stage, subtopic, progress = 0 }) => {
//   const getStageContent = () => {
//     switch(stage) {
//       case 'theory':
...
// // Update the sendBulkCourseContent function
// async function sendBulkCourseContent(clickedTopic, clickedSub) {
//   setShowLoadingPopup(true);
//   setLoadingSubtopic(clickedSub);
...
// // Update the handleSelect function to ensure LoadingPopup shows
// const handleSelect = useCallback((topicTitle, subtopicTitle) => {
//   if (!jsonData) return;
...
// // Update the useEffect that sets initial subtopic
// useEffect(() => {
//   // Only run if we have data
//   if (!courseData || !jsonData) return;
