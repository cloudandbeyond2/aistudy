    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mt-4 text-slate-900 dark:text-white">
            Choose the Right Plan for <br className="hidden md:block" />
            Your Learning Goals
          </h2>
        </motion.div>
            ...
            return (
              <motion.div
                ...
                className={cn(
                  'relative flex flex-col rounded-[40px] p-10 transition-all',
                  isFeatured
                    ? 'bg-slate-900 text-white shadow-2xl scale-105 z-10 py-16 dark:bg-slate-800'
                    : 'bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:shadow-xl py-12'
                )}
              >
                {isFeatured && (
                  <div className="absolute -top-5 inset-x-0 flex justify-center">
