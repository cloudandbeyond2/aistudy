...
const NotificationBell: React.FC<NotificationBellProps> = ({ onNotificationsChange }) => {
    ...
    variant="ghost" 
    size="icon"  
    className="bg-gray-100 dark:bg-gray-800 rounded-2xl p-2 transition-all duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer text-black hover:text-black"
>
