              ...
              <SidebarMenu className={cn(
                ...
                {sessionStorage.getItem('isOrganization') === 'true' && (
                  <>
                    ...
                    {sessionStorage.getItem('role') === 'org_admin' && <MenuItem icon={Users} label="Staff" to="/dashboard/org?tab=staff" isActive={location.search === '?tab=staff'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />}
                    {sessionStorage.getItem('role') === 'org_admin' && <MenuItem icon={CheckCircle2} label="Approvals" to="/dashboard/org?tab=approvals" isActive={location.search === '?tab=approvals'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />}
                    {sessionStorage.getItem('role') === 'org_admin' && <MenuItem icon={Clock} label="Activity" to="/dashboard/org?tab=activity" isActive={location.search === '?tab=activity'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />}
                    <MenuItem icon={FileText} label="Assignments" to="/dashboard/org?tab=assignments" isActive={location.search === '?tab=assignments'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Video} label="Meetings" to="/dashboard/org?tab=meetings" isActive={location.search === '?tab=meetings'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Briefcase} label="Projects" to="/dashboard/org?tab=projects" isActive={location.search === '?tab=projects'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Download} label="Materials" to="/dashboard/org?tab=materials" isActive={location.search === '?tab=materials'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Bell} label="Noticeboard" to="/dashboard/org?tab=notices" isActive={location.search === '?tab=notices'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    {careerEnabled.org_admin && <MenuItem icon={Award} label="Career & Placement" to="/dashboard/org/career" isActive={isActive('/dashboard/org/career') || location.search === '?tab=career'} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />}
                    <MenuItem icon={MessageSquare} label="Student Tickets" to="/dashboard/org/student-tickets" isActive={isActive('/dashboard/org/student-tickets')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={BarChart3} label="KPI Reports" to="/dashboard/org/reports" isActive={isActive('/dashboard/org/reports')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={RotateCcw} label="Quiz Retakes" to="/dashboard/org/quiz-retake-requests" isActive={isActive('/dashboard/org/quiz-retake-requests')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                  </>
                )}
                ...
                {sessionStorage.getItem('role') === 'dept_admin' && (
                  <>
                    ...
                    <MenuItem icon={LayoutDashboard} label="Workboard" to="/dashboard/staff" isActive={isActive('/dashboard/staff')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Briefcase} label="Interview Prep" to="/dashboard/interview-prep" isActive={isActive('/dashboard/interview-prep')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Calendar} label="Calendar Scheduler" to="/dashboard/calendar" isActive={isActive('/dashboard/calendar')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={ListTodo} label="Todo Center" to="/dashboard/todo" isActive={isActive('/dashboard/todo')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={Megaphone} label="Global News" to="/dashboard/news" isActive={isActive('/dashboard/news')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
                    <MenuItem icon={LifeBuoy} label="Support Desk" to="/dashboard/staff/support" isActive={isActive('/dashboard/staff/support')} isExpanded={isExpanded} onMobileClick={handleMobileMenuClick} />
