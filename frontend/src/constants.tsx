...
export const razorpayKeyId = "rzp_test_SNXqWQ4BRcnHhA";
export const razorpayPlanIdOne = "plan_SJqvapiTytNotQ";
export const razorpayPlanIdTwo = "plan_SJsENuOG8v3573";
